  ...
  >
    {!expandedCard || expandedCard === 'cindy' ? (
      <>
        ...
        {expandedCard !== 'cindy' && (
          <>
            <div className="flex items-center justify-center w-12 h-12 rounded-full bg-[#01B2D6]/10 mb-3 group-hover:bg-[#01B2D6]/20 transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-[#01B2D6]">
                <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 00-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 01-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 003 15h-.75M15 10.5a3 3 0 11-6 0 3 3 0 016 0zm3 0h.008v.008H18V10.5zm-12 0h.008v.008H6V10.5z" />
              </svg>
            </div>
            <h3 className="text-2xl font-semibold text-gray-900 mb-1.5">Cindy</h3>
      ...
      <>
        ...
        {expandedCard !== 'chris' && (
          <>
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-1.5">Chris</h3>
            <p className="text-gray-600 mb-3">
      ...
      <>
        ...
        {expandedCard !== 'emily' && (
          <>
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-1.5">Emily</h3>
            <p className="text-gray-600 mb-3">
      ...
      <>
        ...
        {expandedCard !== 'sarah' && (
          <>
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-1.5">Sarah</h3>
            <p className="text-gray-600 mb-3">
      ...
      <>
        ...
        {expandedCard !== 'allison' && (
          <>
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-1.5">Allison</h3>
            <p className="text-gray-600 mb-3">
      ...
      <>
        ...
        {expandedCard !== 'james' && (
          <>
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-1.5">James</h3>
            <p className="text-gray-600 mb-3">
      ...
      <>
        ...
        {expandedCard !== 'olivia' && (
          <>
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-1.5">Olivia</h3>
            <p className="text-gray-600 mb-3">
      ...
      <>
        ...
        {expandedCard !== 'michael' && (
          <>
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-1.5">Michael</h3>
            <p className="text-gray-600 mb-3">
