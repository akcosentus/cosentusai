...
export default function AllVoiceAgents() {
  ...
  return (
    <div className="min-h-screen pt-8 pb-4 px-3 md:pt-20 md:pb-8 md:px-8 bg-transparent">
      <div className="max-w-[1600px] mx-auto relative">
        {/* Logo - Top Right of Grid */}
        <img 
          src="/cosentu-white-logo.png" 
          alt="Cosentus" 
          className="absolute -top-12 right-0 w-28 md:w-48 z-[100]"
        />
  ...
  >
    {!expandedCard || expandedCard === 'cindy' ? (
      <>
        ...
        {expandedCard !== 'cindy' && (
          <>
            <div className="flex items-center justify-center w-10 h-10 md:w-12 md:h-12 rounded-full bg-[#01B2D6]/10 mb-3 group-hover:bg-[#01B2D6]/20 transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 md:w-6 md:h-6 text-[#01B2D6]">
                <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 00-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 01-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 003 15h-.75M15 10.5a3 3 0 11-6 0 3 3 0 016 0zm3 0h.008v.008H18V10.5zm-12 0h.008v.008H6V10.5z" />
              </svg>
            </div>
            <h3 className="text-xl md:text-2xl font-semibold text-gray-900 mb-1.5">Cindy</h3>
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-12 items-start">
            ...
            <div className="flex-1 md:max-w-md">
              <div className="flex items-center gap-4 mb-6">
                <div className="flex items-center justify-center w-16 h-16 md:w-20 md:h-20 rounded-full bg-[#01B2D6]/10">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 md:w-10 md:h-10 text-[#01B2D6]">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 00-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 01-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 003 15h-.75M15 10.5a3 3 0 11-6 0 3 3 0 016 0zm3 0h.008v.008H18V10.5zm-12 0h.008v.008H6V10.5z" />
                  </svg>
                </div>
                <div>
                  <h3 className="text-2xl md:text-4xl font-bold text-gray-900">Cindy</h3>
                  <p className="text-base md:text-lg text-gray-600">Payment & Balance Specialist</p>
                </div>
              </div>
      ...
      <>
        ...
        {expandedCard !== 'chris' && (
          <>
            ...
            <h3 className="text-xl md:text-2xl font-semibold text-gray-900 mb-1.5">Chris</h3>
            <p className="text-gray-600 mb-3">
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-12 items-start">
            ...
            <div className="flex-1 md:max-w-md">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-2xl md:text-4xl font-bold text-gray-900">Chris</h3>
                  <p className="text-base md:text-lg text-gray-600">Insurance Claim Specialist</p>
                </div>
              </div>
      ...
      <>
        ...
        {expandedCard !== 'emily' && (
          <>
            ...
            <h3 className="text-xl md:text-2xl font-semibold text-gray-900 mb-1.5">Emily</h3>
            <p className="text-gray-600 mb-3">
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-12 items-start">
            ...
            <div className="flex-1 md:max-w-md">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-2xl md:text-4xl font-bold text-gray-900">Emily</h3>
                  <p className="text-base md:text-lg text-gray-600">Pre-Service Anesthesia Cost Estimates</p>
                </div>
              </div>
      ...
      <>
        ...
        {expandedCard !== 'sarah' && (
          <>
            ...
            <h3 className="text-xl md:text-2xl font-semibold text-gray-900 mb-1.5">Sarah</h3>
            <p className="text-gray-600 mb-3">
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-12 items-start">
            ...
            <div className="flex-1 md:max-w-md">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-2xl md:text-4xl font-bold text-gray-900">Sarah</h3>
                  <p className="text-base md:text-lg text-gray-600">Medical Appointment Scheduling</p>
                </div>
              </div>
      ...
      <>
        ...
        {expandedCard !== 'allison' && (
          <>
            ...
            <h3 className="text-xl md:text-2xl font-semibold text-gray-900 mb-1.5">Allison</h3>
            <p className="text-gray-600 mb-3">
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-12 items-start">
            ...
            <div className="flex-1 md:max-w-md">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-2xl md:text-4xl font-bold text-gray-900">Allison</h3>
                  <p className="text-base md:text-lg text-gray-600">Customer Service Agent</p>
                </div>
              </div>
      ...
      <>
        ...
        {expandedCard !== 'james' && (
          <>
            ...
            <h3 className="text-xl md:text-2xl font-semibold text-gray-900 mb-1.5">James</h3>
            <p className="text-gray-600 mb-3">
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-12 items-start">
            ...
            <div className="flex-1 md:max-w-md">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-2xl md:text-4xl font-bold text-gray-900">James</h3>
                  <p className="text-base md:text-lg text-gray-600">Eligibility & Benefits Verification</p>
                </div>
              </div>
      ...
      <>
        ...
        {expandedCard !== 'olivia' && (
          <>
            ...
            <h3 className="text-xl md:text-2xl font-semibold text-gray-900 mb-1.5">Olivia</h3>
            <p className="text-gray-600 mb-3">
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-12 items-start">
            ...
            <div className="flex-1 md:max-w-md">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-2xl md:text-4xl font-bold text-gray-900">Olivia</h3>
                  <p className="text-base md:text-lg text-gray-600">Prior Authorization Follow-Up</p>
                </div>
              </div>
      ...
      <>
        ...
        {expandedCard !== 'michael' && (
          <>
            ...
            <h3 className="text-xl md:text-2xl font-semibold text-gray-900 mb-1.5">Michael</h3>
            <p className="text-gray-600 mb-3">
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-12 items-start">
            ...
            <div className="flex-1 md:max-w-md">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-2xl md:text-4xl font-bold text-gray-900">Michael</h3>
                  <p className="text-base md:text-lg text-gray-600">Payment Reconciliation</p>
                </div>
              </div>
